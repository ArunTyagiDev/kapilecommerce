    ...
    <div class="tab-content" id="productTabsContent">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Use subcategories (e.g. Shoes → Women Shoes), not parent only.</small>
                        @error('category_id')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        <div class="tab-pane fade" id="attributes" role="tabpanel">
            <div class="alert alert-secondary small">
                <strong>Step 1:</strong> On <em>Basic Info</em>, choose subcategory.<br>
                <strong>Step 2:</strong> Here, tick sizes &amp; colors → check <em>Generate Variants</em>.<br>
                <strong>Step 3:</strong> On <em>Images</em> tab, upload main photo + one photo per color.
            </div>
            <div id="category-attributes-container">
                <p class="text-muted">Select a subcategory on Basic Info to load Size / Color options</p>
            </div>
        ...
        <div class="tab-pane fade" id="images" role="tabpanel">
            <div class="alert alert-primary">
                <strong>Main product image:</strong> upload below. The <strong>first image</strong> becomes the main photo in the store.
            </div>
            <div class="mb-3">
                <label for="images" class="form-label">Gallery / Main images *</label>
                <input type="file" class="form-control @error('images.*') is-invalid @enderror" id="images" name="images[]" accept="image/*" multiple>
                <small class="form-text text-muted">Select one or more JPG/PNG. First file = main image on listing.</small>
                @error('images.*')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
